            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center"><p class="large text-muted">
                            ...
                            <a class="btn btn-outline-primary btn-md text-uppercase" href="/BioEShop/view_about">Our story</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="page-section bg-light" id="services">
            <div class="container">
                <div class="text-center">
                    ...
                    <a class="btn btn-outline-primary" href="/BioEShop/products"> View All</a>
